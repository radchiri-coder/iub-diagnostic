...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    kind: 'main',
    categoryId: 'clarity',
    prompt: 'Пятница вечер. Вы спрашиваете руководителя отдела: «Над чем твоя команда будет работать на следующей неделе?» Какой ответ вероятнее?',
    options: [
      { id: 'clarity_2_a', label: 'Назовёт 2–3 задачи, привязанные к квартальным целям', score: 10, originalOrder: 0 },
      { id: 'clarity_2_b', label: 'Перечислит текущие дела — правильные, но без связи с большой картиной', score: 6, originalOrder: 1 },
